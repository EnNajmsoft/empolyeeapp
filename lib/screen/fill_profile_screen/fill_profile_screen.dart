...
import 'package:empolyeeapp/widgets/custom_switch.dart';
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text("admin"),
                              Switch(
                                value: controller.switchselect,
                                onChanged: (val) {
                                  controller.switchselect = val;
                                  controller.showjop();
                                },
                              ),
                            ],
                                        ...
                                        return Column(
                                          children: [
                                            ListTile(
                                              ...
                                              onTap: () {
                                                controller.jopid.text =
                                                    controller.jopsdep[index]
                                                        .jopName!;
                                                controller.jopselect =
                                                    controller
                                                        .jopsdep[index].jopId!;
